...
CSS_PROP_XUL(-moz-box-flex-group, box_flex_group, MozBoxFlexGroup, NS_STYLE_HINT_REFLOW, XUL, mBoxFlexGroup, eCSSType_Value, PR_FALSE) // XXX bug 3935
