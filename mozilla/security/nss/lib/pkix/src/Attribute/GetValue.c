...
#ifdef DEBUG
static const char CVS_ID[] = "@(#) $Source: /cvsroot/mozilla/security/nss/lib/pkix/src/Attribute/GetValue.c,v $ $Revision: 1.1 $ $Date: 2000/03/31 19:09:53 $ $Name: MOZILLA_1_3_1_RELEASE $";
#endif /* DEBUG */
