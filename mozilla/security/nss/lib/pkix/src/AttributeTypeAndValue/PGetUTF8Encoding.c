...
#ifdef DEBUG
static const char CVS_ID[] = "@(#) $Source: /home/kai/cvsmo/data/mozilla/security/nss/lib/pkix/src/AttributeTypeAndValue/PGetUTF8Encoding.c,v $ $Revision: 1.1 $ $Date: 2000/03/31 19:13:30 $ $Name:  $";
#endif /* DEBUG */
