...
#ifdef DEBUG
static const char CVS_ID[] = "@(#) $Source: /cvsroot/mozilla/security/nss/lib/pkix/src/AttributeTypeAndValue/PEncode.c,v $ $Revision: 1.1 $ $Date: 2000/03/31 19:13:28 $ $Name: MOZILLA_1_3_1_RELEASE $";
#endif /* DEBUG */
