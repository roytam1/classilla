...
#ifdef DEBUG
static const char CVS_ID[] = "@(#) $Source: /home/kai/cvsmo/data/mozilla/security/nss/lib/pkix/src/AlgorithmIdentifier/MClear.c,v $ $Revision: 1.1 $ $Date: 2000/03/31 19:06:07 $ $Name:  $";
#endif /* DEBUG */
