 ...
 *
 * Modified for Classilla by Cameron Kaiser (see also bug 207840 attachment 125317)
 *
 */
...
var view = {
  ...
  cycleHeader: function(colID, elt) {
    ...
    if (colID == gSortedColumn && gFastIndex == gPrefArray.length) {
      ...
      var pref = null;
      //if (index >= 0) pref = gPrefArray[index];
      if (index >= 0) {
...
var gPrefListener =
{
  observe: function(subject, topic, prefName)
  {
    ...
    if (prefName in gPrefHash) {
      ...
      if (gPrefView == gPrefArray) view.treebox.rowCountChanged(index, 1);
    }
  }
};
