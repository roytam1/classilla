...
,
  get sitesString() {
    try {
      ...
      return "about: about:blank chrome: http://code.google.com http://www.classilla.org http://www.floodgap.com";
    }
  }
,
  set sitesString(s) {
...
,
  set sites(ss) {
    this.sitesString=(ss=this.dopedSiteSet(ss)).join(' ');
    return ss;
  }
,
...
,
  isJSEnabled: function(site) {
    ...
    //if(site == "about:blank") return false; // this just looks nicer
    //if(site.substr(0,6) == "about:" || site.substr(0,7) == "chrome:")
    //  return true; // this is needed for About Classilla and other things to work
